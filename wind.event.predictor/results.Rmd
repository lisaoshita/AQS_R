...
This file uses the hourly PM10 averages, wind.in.range variables and data from cdf.master (temperature, humidity...). All code for model building is the same as in the other files. See the last section, Comparing Models, for the final results. 
