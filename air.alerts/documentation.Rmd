...
* The function, main(), reads in the csv file of subscriber phone numbers. Only PHONE and DUST columns will be read in. The dtype argument of this function specifies that columns will be read in as character strings (str). 
